...
class TestSchedulerService:
    ...
    async def test_create_task_success(self):
        ...
        result_model = ScheduledTaskResponse.model_validate(result)
    ...
    async def test_get_all_tasks(self):
        ...
        result_models = [ScheduledTaskResponse.model_validate(r) for r in result]
    ...
    async def test_get_task_executions(self):
        ...
        result_models = [TaskExecutionResponse.model_validate(r) for r in result]
