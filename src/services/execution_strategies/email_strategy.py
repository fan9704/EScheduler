...
class EmailExecutionStrategy(ExecutionStrategy):
    ...
    def __init__(self):
        ...
        logger.info(f"EmailExecutionStrategy 初始化完成 - SMTP: {self.smtp_host}:{self.smtp_port}, TLS: {self.use_tls}, SSL: {self.use_ssl}")
    ...
    async def execute(self, target_arn: str, target_input: Dict[str, Any]) -> ExecutionResult:
        ...
        try:
            ...
            if use_template and template_id:
                ...
                # 直接發送
                result = await self._send_direct_email(target_arn, target_input, start_time)
