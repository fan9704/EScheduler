...
class EmailExecutionStrategy(ExecutionStrategy):
    ...
    async def _send_with_template(self, target_arn: str, target_input: Dict[str, Any],
    ...
    async def _create_usage_record(self, template: EmailTemplate, variables_used: Dict[str, Any],
                                   ...
                                   sender: str, is_successful: bool,
                                   error_message: Optional[str] = None) -> EmailTemplateUsage:
        """創建模板使用記錄"""
