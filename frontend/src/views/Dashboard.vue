  ...
  <div>
    ...
    <v-row class="mb-6">
      <v-col cols="12" sm="6" md="3">
        <v-card class="pa-4">
          <div class="d-flex align-center">
            <v-icon size="40" color="primary" class="mr-3"> mdi-clock-outline </v-icon>
            <div>
              <div class="text-h5 font-weight-bold">
                {{ dashboard_metrics.total_tasks || 0 }}
              </div>
              <div class="text-caption text-medium-emphasis">總任務數</div>
            </div>
          </div>
        </v-card>
      </v-col>
      ...
      <v-col cols="12" sm="6" md="3">
        <v-card class="pa-4">
          <div class="d-flex align-center">
            <v-icon size="40" color="success" class="mr-3"> mdi-check-circle-outline </v-icon>
            <div>
              <div class="text-h5 font-weight-bold">
                {{ dashboard_metrics.enabled_tasks || 0 }}
              </div>
              <div class="text-caption text-medium-emphasis">啟用任務</div>
            </div>
          </div>
        </v-card>
      </v-col>
      ...
      <v-col cols="12" sm="6" md="3">
        <v-card class="pa-4">
          <div class="d-flex align-center">
            <v-icon size="40" color="warning" class="mr-3"> mdi-pause-circle-outline </v-icon>
            <div>
              <div class="text-h5 font-weight-bold">
                {{ dashboard_metrics.disabled_tasks || 0 }}
              </div>
              <div class="text-caption text-medium-emphasis">禁用任務</div>
            </div>
          </div>
        </v-card>
      </v-col>
      ...
      <v-col cols="12" sm="6" md="3">
        <v-card class="pa-4">
          <div class="d-flex align-center">
            <v-icon size="40" color="info" class="mr-3"> mdi-play-circle-outline </v-icon>
            <div>
              <div class="text-h5 font-weight-bold">
                {{ dashboard_metrics.today_executions_count || 0 }}
              </div>
              <div class="text-caption text-medium-emphasis">今日執行</div>
            </div>
          </div>
        </v-card>
      </v-col>
      ...
      <v-col cols="12" lg="8">
        <v-card>
          <v-card-title class="d-flex align-center justify-space-between">
            <span>最近任務</span>
            <v-btn variant="text" size="small" to="/tasks"> 查看全部 </v-btn>
          </v-card-title>
          <v-card-text>
            ...
            <div v-else class="text-center py-8">
              ...
              <div class="text-h6 mt-2 text-medium-emphasis">暫無任務</div>
              <v-btn color="primary" class="mt-4" to="/tasks/create"> 創建第一個任務 </v-btn>
            </div>
          </v-card-text>
        </v-card>
      </v-col>
