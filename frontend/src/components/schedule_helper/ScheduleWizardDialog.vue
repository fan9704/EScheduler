            ...
            <v-card v-else-if="scheduleHelperStore.currentExpression">
              ...
              <v-card-text>
                ...
                <div class="mb-3">
                  ...
                  <v-chip
                    size="small"
                    :color="scheduleHelperStore.currentExpression.type === 'cron' ? 'primary' : 'secondary'"
                    variant="flat"
                  >
                ...
                <div class="mb-4" v-if="scheduleHelperStore.currentExpression.next_runs?.length">
                  <div class="text-caption text-medium-emphasis">接下來的執行時間</div>
                  <v-list density="compact">
                    <v-list-item
                      v-for="(time, index) in scheduleHelperStore.currentExpression.next_runs.slice(0, 5)"
                      :key="index"
                      class="px-0"
                    >
